...
const Logo = () => {
  return (
    <Link href='/'>
      <a className="">
        <svg className="h-[60px] w-[76px] hover:animate-spin text-black dark:text-white hover:text-cta dark:hover:text-cta transition-colors" viewBox="0 0 758.000000 600.000000" xmlns="http://www.w3.org/2000/svg">
