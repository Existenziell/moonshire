...
const Wallet = () => {
  ...
  if (overlayShown) return (
    <div className='flex items-center justify-center text-center'>
      ...
      {/* Overlay */}
      <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 rounded-xl bg-white dark:bg-brand-dark w-full md:max-w-2xl p-6'>
        ...
        <div className='absolute top-0 right-0 z-30'>
          <svg onClick={() => setOverlayShown(false)} xmlns="http://www.w3.org/2000/svg" className="h- w- text-brand-dark hover:text-cta transition-all cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
