    ...
    <div className='mr-4'>
      <Link href='/profile'>
        <a className='button button-connect flex justify-around items-center relative'>
          <span className='peer h-full w-full flex items-center justify-center pr-4'>
            {currentUser?.username ? currentUser?.username : `Profile`}
          </span>
          <svg xmlns="http://www.w3.org/2000/svg" className=" absolute right-4 top-4 h-6 w-6 peer-hover:animate-spin hover:animate-spin" viewBox="0 0 20 20" fill="currentColor">
