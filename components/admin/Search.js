    ...
    <div className='flex justify-end items-end absolute right-0 -top-[80px]'>
      <div className='relative'>
        <input
          ...
          name='search'
          placeholder='SEARCH'
          className='h-[40px] min-w-[150px] text-tiny ml-2 border-2 border-detail rounded-none focus:ring-0 focus:border-cta dark:focus:border-cta dark:border-detail-dark font-serif bg-brand dark:bg-brand-dark text-black dark:text-white'
